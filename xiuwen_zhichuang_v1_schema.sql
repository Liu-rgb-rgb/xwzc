...
/*==============================================================*/
/* AI 生图异步化补充：进度与最后更新时间（2026-09-22）             */
/*==============================================================*/
ALTER TABLE `pattern_generation` ADD COLUMN `progress` INT NOT NULL DEFAULT 0 COMMENT '生成进度0-100' AFTER `status`;
ALTER TABLE `pattern_generation` ADD COLUMN `updated_at` DATETIME DEFAULT NULL COMMENT '最后更新时间' AFTER `created_at`;
