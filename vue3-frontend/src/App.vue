...
<template>
  ...
  >
    ...
    <footer>
      ...
      <div>
        <b>平台服务</b><RouterLink to="/generate">AI纹样生成</RouterLink
        ><RouterLink to="/products">文创商品</RouterLink
        ><RouterLink to="/customize">纹样定制</RouterLink>
      </div>
      <div>
        <b>学习支持</b><RouterLink to="/courses">非遗课堂</RouterLink
        ><RouterLink to="/resources">创作资源</RouterLink
        ><RouterLink to="/resources">帮助中心</RouterLink>
      </div>
      <div>
